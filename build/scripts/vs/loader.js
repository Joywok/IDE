...
! function (e) {
    ...
    function o() {
        v = "function" == typeof A.importScripts, m = "undefined" != typeof process && "undefined" != typeof process.versions && "undefined" != typeof process.versions.electron && "renderer" === process.type, M = "undefined" != typeof process && "undefined" != typeof process.versions && "undefined" != typeof process.versions.electron && "browser" === process.type, D = "undefined" != typeof module && !!module.exports, E = new C(v ? new k : D ? new w : new S), b = new y(E), E.setModuleManager(b)
    }
        ...
        if (o(), r(), i(), D) {
            var e = A.require || require,
                t = function (t) {
                    ...
                    var n = e(t);
                    return b.getRecorder().record(h.NodeEndNativeRequire, t), n
                };
            A.nodeRequire = t, O.nodeRequire = t
        }
    ...
    var a = function () {
        ...
        return e.prototype._createOverwriteModuleIdToPath = function () {
            ...
            var e = this;
            this.sortedPathsRules = [], d.forEachProperty(this.options.paths, function (t, n) {
            ...
            var e = this;
            this.shimModules = {}, this.shimModulesStr = {}, d.forEachProperty(this.options.shim, function (t, n) {
            ...
            for (var t, n = 0, o = this.sortedPathsRules.length; n < o; n++)
                if (t = this.sortedPathsRules[n], d.startsWith(e, t.from)) {
            ...
            var n;
            if (d.endsWith(t, ".js") || d.isAbsolutePath(t)) d.endsWith(t, ".js") || d.containsQueryString(t) || (t += ".js"), n = [t];
            else {
            ...
            var t = e;
            return d.isAbsolutePath(t) || (t = this._applyPaths(t)[0], d.isAbsolutePath(t) || (t = this.options.baseUrl + t)), this._addUrlArgsIfNecessaryToUrl(t)
    ...
    var c = function () {
        ...
        return e.prototype.isBuild = function () {
            ...
            var n = t;
            return d.isAbsolutePath(n) || (d.startsWith(n, "./") || d.startsWith(n, "../")) && (n = e._normalizeModuleId(this.fromModulePath + n)), n
        }, e.prototype.moduleIdToPaths = function (e) {
            var t = this._config.moduleIdToPaths(e);
            return D && e.indexOf("/") === -1 && t.push("node|" + this.fromModulePath + "|" + e), t
        }, e.prototype.requireToUrl = function (e) {
    ...
    var p = function () {
        function e(e, t, n, o, r, i, s, u) {
            void 0 === u && (u = null), this._id = e, this._dependencies = t, this._dependenciesValues = [], this._callback = n, this._errorback = o, this._recorder = r, this._moduleIdResolver = i, this._exports = {}, this._exportsPassedIn = !1, this._config = s, this._defineCallStack = u, this._digestDependencies(), 0 === this._unresolvedDependenciesCount && this._complete()
        }
        return e.prototype._digestDependencies = function () {
            ...
            var t, n, o;
            for (t = 0, n = this._dependencies.length; t < n; t++)
            ...
            if (this._callback)
                if ("function" == typeof this._callback) {
                    ...
                    e = t.producedError, this._recorder.record(h.EndInvokeFactory, this._id), e || "undefined" == typeof t.returnedValue || this._exportsPassedIn && !d.isEmpty(this._exports) || (this._exports = t.returnedValue)
    ...
    var y = function () {
        function e(e) {
            this._recorder = null, this._config = new a, this._scriptLoader = e, this._modules = {}, this._knownModules = {}, this._inverseDependencies = {}, this._dependencies = {}, this._inversePluginDependencies = {}, this._queuedDefineCalls = [], this._loadingScriptsCount = 0, this._resolvedScriptPaths = {}, this._checksums = {}
        }
        return e._findRelevantLocationInStack = function (e, t) {
            ...
            return this._recorder || (this._config.shouldRecordStats() ? this._recorder = new g(P) : this._recorder = _.INSTANCE), this._recorder
            ...
            if (o >= 0) {
                ...
                i = "function" == typeof s.normalize ? s.normalize(i, u) : u(i), n = r + "!" + i
            }
            ...
            t ? this._config = new a(e) : this._config = this._config.cloneAndMerge(e), this._config.shouldRecordStats() && !n && (this._recorder = null)
            ...
            for (s.push(e), r[e] = !0; s.length > 0;)
                if (n = s.shift(), this._modules[n] && (i = this._modules[n].onDependencyError(o) || i), this._inverseDependencies[n])
                    for (var u = 0, d = this._inverseDependencies[n].length; u < d; u++) r.hasOwnProperty(this._inverseDependencies[n][u]) || (s.push(this._inverseDependencies[n][u]), r[this._inverseDependencies[n][u]] = !0);
            ...
            if (delete this._dependencies[e], this._inverseDependencies.hasOwnProperty(e)) {
                ...
                for (delete this._inverseDependencies[e], n = 0, o = s.length; n < o; n++) r = s[n], i = this._modules[r], i.resolveDependency(e, t), i.isComplete() && this._onModuleComplete(r, i.getExports())
            }
            if (this._inversePluginDependencies.hasOwnProperty(e)) {
                ...
                for (delete this._inversePluginDependencies[e], n = 0, o = u.length; n < o; n++) {
                    var l = u[n].moduleId,
                        a = this._modules[l];
                    this._resolvePluginDependencySync(l, u[n].dependencyId, t), a.isComplete() && this._onModuleComplete(l, a.getExports())
                }
            }
            ...
            var n, o, r, i, s, u = {},
                d = [];
            for (d.push(e), u[e] = !0; d.length > 0;)
                if (r = d.shift(), this._dependencies.hasOwnProperty(r))
                    for (i = this._dependencies[r], n = 0, o = i.length; n < o; n++) {
            ...
            for (var o, r = this._dependencies[e], i = 0, s = r.length; i < s; i++)
            ...
            if (d = "function" == typeof n.normalize ? n.normalize(d, l) : l(d), n.dynamic) {
                ...
                var c = t;
                t = u + "!" + d, r.renameDependency(c, t), this._resolveDependency(e, t, function (e) {
                    var r = function (e) {
            ...
            var o = e.moduleIdToPaths(t),
                ...
                i = function (e) {
                    if (r++, r >= o.length) n._onLoadError(t, e);
                        ...
                        u.record(h.BeginLoadingScript, s), n._scriptLoader.load(s, function () {
                            n._config.isBuild() && (n._resolvedScriptPaths[t] = s), u.record(h.EndLoadingScriptOK, s), n._onLoad(t)
                        }, function (e) {
                            u.record(h.EndLoadingScriptError, s), i(e)
                        }, u)
                    }
                };
            i(null)
            ...
            for (t = 0, n = r.length; t < n; t++) i = r[t], "require" !== i ? i.indexOf("!") >= 0 ? this._resolvePluginDependency(o, i) : this._resolveDependency(o, i, d) : e.resolveDependency(i, this._createRequire(s));
    ...
    var v, m, M, D, E, b, P, C = function () {
            ...
            return e.prototype.setModuleManager = function (e) {
                ...
                if (this._init(l), /^node\|/.test(t)) {
                    var c = t.split("|"),
                        p = null;
                    try {
                        r.record(h.NodeBeginNativeRequire, c[2]), p = l(c[2])
                    } catch (e) {
                        return r.record(h.NodeEndNativeRequire, c[2]), void o(e)
                    }
                    r.record(h.NodeEndNativeRequire, c[2]), this._moduleManager.enqueueDefineAnonymousModule([], function () {
                        return p
                    }), n()
                } else t = d.fileUriToFilePath(t), this._fs.readFile(t, {
                    encoding: "utf8"
                }, function (s, d) {
                    ...
                    if (m) {
                        var p = c.match(/^([a-z])\:(.*)/i);
                        p && (c = p[1].toUpperCase() + ":" + p[2]), c = "file:///" + c.replace(/\\/g, "/")
                    }
                    var f, g = "(function (require, define, __filename, __dirname) { ",
                        _ = "\n});";
                    f = d.charCodeAt(0) === e._BOM ? g + d.substring(1) + _ : g + d + _, f = a(f, c);
                    var y;
                    y = /^v0\.12/.test(process.version) ? i._vm.runInThisContext(f, {
                        filename: c
                    }) : i._vm.runInThisContext(f, c), y.call(A, O, I, c, i._path.dirname(t)), r.record(h.NodeEndEvaluatingScript, t), n()
                })
            }, e._BOM = 65279, e
        }(),
        I = function () {
            function e(e, t, n) {
                "string" != typeof e && (n = t, t = e, e = null), "object" == typeof t && d.isArray(t) || (n = t, t = null), t || (t = ["require", "exports", "module"]), e ? b.enqueueDefineModule(e, t, n) : b.enqueueDefineAnonymousModule(t, n)
            }
            return e.amd = {
                jQuery: !0
            }, e
        ...
        O = function () {
            ...
            return e.config = function (e, t) {
                ...
                b = new y(E), E.setModuleManager(b)
