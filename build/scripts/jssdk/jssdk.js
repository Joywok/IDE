...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	  if (typeof module !== 'undefined' && ( false ? 'undefined' : _typeof(exports)) === 'object') {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(731), __webpack_require__(732)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_) {
	      return root.jw = factory(root, $, _);
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else {
	    root.jw = factory(root, root.jQuery, root._);
	  }
	})(undefined, function (root, $, _) {
	  ...
	  function combineData(data) {
	    ...
	    return data = data || {}, data.appId = jwParams.appid, data.verifyAppId = jwParams.appid, data.verifySignType = "sha1", data.verifyTimestamp = jwParams.timestamp + "", data.verifyNonceStr = jwParams.nonceStr, data.verifySignature = jwParams.signature, data;
	    // JSON.stringify(data);
	  }
	  ...
	  var jw = jw || {
	    ...
	    getAuthCode: function getAuthCode(origindata) {
